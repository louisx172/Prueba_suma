...
def create_animation(frames, output_file='bucket_sort_animation.html'):
    ...
    pio.write_html(fig, file=output_file, auto_open=True)  # Guardar la animación en un archivo HTML y abrirlo en el navegador
    print(f"La animación ha sido guardada en {output_file}")  # Mensaje de confirmación
